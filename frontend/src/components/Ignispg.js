    ...
    <div>
      ...
      <section className="ignis-highlights-section">
        ...
        <div className="ignis-highlights-container">
          <Highlights
            src="https://nexaprod2.azureedge.net/-/media/feature/nexawebsitebrandpagehighlights/ignis/ags.
              webp?la=en&hash=BF918CB53EAD17B536D5584301D3FCE9"
            name="AUTO GEAR SHIFT"
          />
          <Highlights
            ...
            name="PEPPY 1.2L VVT PETROL ENGINE"
          />
          <Highlights
            ...
            name="LED PROJECTOR HEADLAMPS WITH LED DRLs"
          />
          <Highlights
            src="https://nexaprod3.azureedge.net/-/media/feature/nexawebsitebrandpagehighlights/ignis/interior.webp?
          la=en&hash=9F6A943A205D2C90E831972A042ADF15"
            name="SPACIOUS & COMFORTABLE INTERIORS"
          />
          <Highlights
            ...
            name="A17.78 CM TOUCHSCREEN SMARTPLAY STUDIO"
          />
        </div>
      </section>
